...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::share_links::receive_share_file,
            commands::share_links::receive_share_folder,
            commands::search::search_files,
            commands::search::get_file_stats,
            commands::search::list_files,
            commands::search::browse_share_dir,
            ...
            commands::auth::fetch_user_directory_tree,
            commands::auth::get_receive_target,
            commands::auth::set_receive_target,
